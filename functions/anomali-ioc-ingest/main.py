...
# Handle dodo environment cloud configuration
if os.environ.get("CS_CLOUD") == "dodo-red":
    os.environ['CS_CLOUD'] = "https://api.dodo.crowdstrike.red"
elif os.environ.get("CS_CLOUD") == "dodo-black":
    os.environ['CS_CLOUD'] = "https://api.dodo.crowdstrike.black"
