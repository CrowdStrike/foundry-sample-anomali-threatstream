...
- **Foundry Function**: `anomali-ioc-ingest` - Ingests IOC data from Anomali ThreatStream and creates CSV lookup files for Falcon Next-Gen SIEM (available in both Python and Go implementations)
